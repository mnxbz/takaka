...
//—————「 Setting Owner 」—————//
global.owner = ['6281575886399','6283839255168','6281575886399'] //ubah jadi nomor kamu
global.premium = ['6281575886399'] //ubah jadi nomor kamu
global.ownernomer = '6283839255168' //ubah jadi nomor kamu

//—————「 Set Nama Own & Bot 」—————//
global.ownername = 'BRILY' //ubah jadi nama kamu
global.botname = 'SALTER BOTZ' //ubah jadi nama bot kamu
global.footer = 'SALTER' //ubah jadi nama kamu

//—————「 Set Kebutuhan Button & Kontak 」—————//
global.youtube = '-' //ubah jadi link yt kmu, kalau gk pnya gsh di gnti anggap aja credits :)
global.ig = '-' //ubah jadi link ig kamu
global.mygc = '-' //ubah jadi link group kamu
global.myweb = '-' //terserah mau ubah/nggak
global.email = '-' //ubah jadi email kamu
global.region = 'indonesia' //terserah mau ubah/nggak

//—————「 Set Wm 」—————//
global.packname = '© SALTER BOTZ' //ubah jadi nama bot kamu
global.author = 'BRILY' //ubah jadi nama kamu
...
global.velochika = fs.readFileSync('./image/salter.mp4')
